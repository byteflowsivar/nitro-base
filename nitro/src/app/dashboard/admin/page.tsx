        ...
        <div className="space-y-4">
          <div className="bg-amber-50 p-4 rounded-md border border-amber-200 dark:bg-amber-900/20 dark:border-amber-800">
            ...
            <p className="text-sm text-amber-700 dark:text-amber-400">
              Solo los administradores pueden ver y administrar esta sección. Tu rol actual es:{' '}
              <span className="font-bold">
                {session?.user?.roles?.includes('admin') ? 'Administrador' : 'No autorizado'}
              </span>
            </p>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400">
            <p>
              Aquí aparecería un listado de todos los usuarios registrados con opciones para editar
              roles y permisos.
            </p>
          </div>
        </div>
