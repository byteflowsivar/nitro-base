...
describe('ChangePasswordForm', () => {
  ...
  it('muestra error cuando las contraseñas no coinciden', async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText(/ingresa tu contraseña actual/i), 'Password123!');
    await userEvent.type(screen.getByPlaceholderText(/crea una contraseña segura/i), 'NewPass123!');
    await userEvent.type(screen.getByPlaceholderText(/confirma tu nueva contraseña/i), 'DifferentPass123!');
